...
export default function Navbar() {
  ...
  const desktopLinkStyle = "hover:text-primaryOrange transition-colors decoration-orange-500 decoration-2 underline-offset-4 font-medium text-sm lg:text-base";
  const mobileLinkStyle = "hover:text-primaryOrange transition-colors decoration-orange-500 decoration-2 underline-offset-4 font-bold text-2xl text-slate-900";
